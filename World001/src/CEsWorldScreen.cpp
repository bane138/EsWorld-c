...
bool CEsWorldScreen::setupScreen(void)
{
    ...
    // SDL Window
    SDL_Window *sdl_wWindow = SDL_CreateWindow("EsWorld",
                                            100,100,
                                            m_nWidth, m_nHeight,
                                            SDL_WINDOW_SHOWN);
    if(sdl_wWindow == nullptr) {
    ...
    // SDL Renderer
    SDL_Renderer *sdl_rRenderer = SDL_CreateRenderer(sdl_wWindow, -1,
                                                    SDL_RENDERER_ACCELERATED | SDL_RENDERER_PRESENTVSYNC);
    if(sdl_rRenderer == nullptr) {
    ...
    // Resource path
    sResourcePath = getResourcePath("EsWorld");
}
...
{
    cleanup(sdl_tBackground, sdl_rResource, sdl_wWindow);
}

/**
 * @brief CEsWorldScreen::createScreen
 */
void CEsWorldScreen::createScreen(void)
{
...
/**
  ...
  */
SDL_Texture* CEsWorldScreen::loadTexture(const string &file, SDL_Renderer *renderer) {
